...
const messages = {
  ...
  comfort: [
    ...
    "You don't have to be okay every second. Some days are just hard, and that's okay. Let this one be hard. Let yourself rest. You don't have to pretend you're fine just because someone expects you to.",
  ...
  /* =========================================================
     🧡 MOTIVATION — YOU GOT THIS, PRINCESS.
     ========================================================= */
...
function getHistoryKey(jarId) {

  return `vijemin-history-${jarId}`;

}


/* =========================================================
   GET USED MESSAGE INDEXES
========================================================= */

function getUsedIndexes(jarId) {
  ...
  try {
    ...
    console.error(
      "Could not read message history:",
      error
    );
...
/* =========================================================
   SAVE USED MESSAGE INDEX
========================================================= */

function saveUsedIndex(
  jarId,
  index
) {

  const usedIndexes =
    getUsedIndexes(jarId);
...
function isJarEmpty(jarId) {
  ...
  return (
    usedIndexes.length >= pool.length
  );
...
const emptyMessages = {
  ...
  comfort:
    "You've taken all 50 doses from this jar. Take a little break, sayang. This jar needs a refill. ♡",

  motivation:
    "You actually finished all 50 doses? Damn, princess. This jar is officially empty. Looks like it needs a refill.",

  missyou:
    "You finished all 50 doses? And somehow I still miss you. Unfortunately, this jar is empty. Come back when it gets a refill, sayang. ♡",

  love:
    "You made it through all 50 doses, and somehow I still have more love to give. Unfortunately, the jar doesn't. Refill needed, sayangku. ♡"
